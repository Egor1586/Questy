...
#         list_clothes_bd = user.avatar
#         list_clothes_bd = list_clothes_bd.split("|")

#         list_clothes = []
#         for clothing in list_clothes_bd:
#             list_clothes.append(int(clothing))
...
#                 if index == 0:
#                     new_avatar = new_avatar + flask.request.form.get(name_classes[index])
#                 else:
#                     new_avatar = new_avatar + "|" +  flask.request.form.get(name_classes[index])
#             user.avatar = new_avatar
#             db.session.commit()
#             return flask.redirect(f"/edit_avatar{user_id}")
#     else:
